...
class UserProfileTest(APITestCase):
    ...
    def test_view_profile(self):
        ...
        try:
            ...
            user_address = None
        user_dict = {'id': self.user.id, 'username': self.user.username, 'useraddress': user_address, 'first_name': self.user.first_name, 'last_name': self.user.last_name, 'email': self.user.email, 'user_type': self.user.user_type, 'gender': self.user.gender, 'phone_number': self.user.phone_number}
